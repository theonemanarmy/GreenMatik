<section class="terminos container">
  ...
  <div class="container" style="margin-top:30px; margin-bottom:70px;">
    ...
    <p></p>
    <p>&nbsp;</p>
    <p>El presente Términos y Condiciones establece los términos en que <strong>GreenMatik</strong>
    ...
    <p><strong>GreenMatik</strong> está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no autorizado.</p>
    ...
    <p><strong>GreenMatik</strong> Se reserva el derecho de cambiar los términos de la presente Términos y Condiciones en cualquier momento.</p>
    <br><br>
    <a href="#" onclick="history.back();"> <i class="fas fa-undo"></i> Regresar</a>
