        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="row">
                        <a onclick="history.back();"> <button class="btn btn-productos-claro mont">
                                <h6><i class="fas fa-undo"></i> <strong>Regresar</strong></h6>
                            </button></a>
                        <a href="contacto.php"> <button class="btn btn-productos btn-productos-oculto mont" id="prueba">
                                <strong>Contáctanos</strong></button></a>
                    </div>
                </div>
