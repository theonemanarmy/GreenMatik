...
ALTER TABLE PRODUCTOS ADD descripcion1 VARCHAR(100) NOT NULL;
ALTER TABLE PRODUCTOS ADD descripcion2 VARCHAR(100) NOT NULL;
ALTER TABLE PRODUCTOS ADD descripcion3 VARCHAR(100) NOT NULL;
ALTER TABLE PRODUCTOS ADD descripcion4 VARCHAR(100) NOT NULL;
ALTER TABLE PRODUCTOS ADD descripcion5 VARCHAR(100) NULL;
ALTER TABLE PRODUCTOS ADD descripcion6 VARCHAR(100) NULL;
ALTER TABLE PRODUCTOS ADD descripcion7 VARCHAR(100) NULL;
ALTER TABLE PRODUCTOS ADD descripcion8 VARCHAR(100) NULL;